...
#El mapa y el recorrido del personaje principal se define utilizando nodos. 
class Node(object):
...
#Se renderiza el camino que va a estar disponible para el personaje
...
#Se agrupan los nodos para poder recorrerlos
#Se inicia en una lista vacía 
#Como se estan utilizando una importante cantidad de nodos, es mejor definir un grupo de ellos en vez de trabajar nodo por nodo de manera individual 
class NodeGroup(object):
    ...
    #Este método se encarga de crear el espacio del centro donde las TortiRicas Spawnean 
    ...
    #Este metodo se encarga de conectar los nodos del centro del mapa de los fantasmas hacia el resto del mapa 
