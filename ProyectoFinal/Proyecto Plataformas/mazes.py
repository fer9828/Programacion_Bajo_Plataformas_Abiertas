...
class MazeBase(object):
    ...
    def getFruitNode(self, nodegroup):
        ...
        return nodegroup.nodesLUT[key]
#Definición para el portal, con ello Draco puede entrar por un lado del mapa y salir del otro.
...
#Inicialización del primer laberinto.
...
#Inicialización del segundo laberinto.
