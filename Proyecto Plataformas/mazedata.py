...
#Estos son todos los valores específicos del primer laberinto.
...
#Este laberinto tiene 2 ubicaciones de portal en lugar de solo una.
...
#Esta clase solo agrupa las clases de laberinto. 
#Llamaremos al método loadMaze desde el exterior para obtener el objeto laberinto según el nivel.
